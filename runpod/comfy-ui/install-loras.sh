...
lora_url="https://civitai.com/api/download/models/134343"
if [[ ! -f ${lora_file} ]]; then
    wget -O ${lora_file} ${lora_url}
fi

lora_file=${loras_dir}/Aether_Cloud_v1.safetensors
lora_url="https://civitai.com/api/download/models/141029"
if [[ ! -f ${lora_file} ]]; then
    wget -O ${lora_file} ${lora_url}
fi

lora_file=${loras_dir}/lora-sdxl-flaming-person.safetensors
lora_url="https://civitai.com/api/download/models/119389"
if [[ ! -f ${lora_file} ]]; then
    wget -O ${lora_file} ${lora_url}
fi
